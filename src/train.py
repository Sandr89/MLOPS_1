...
def main():
    ...
    parser.add_argument("model_dir", type=str, help="Path to save model (e.g. data/models)")
    ...
    plot_feature_importance(model, list(feature_names), save_path=str(plot_path))
